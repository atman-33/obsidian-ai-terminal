# Agent Settings Specification Delta

## Overview

This specification defines the UUID-based agent identification system. It supersedes the previous name-based identification approach.
