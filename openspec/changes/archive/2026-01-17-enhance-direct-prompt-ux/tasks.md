...
- [x] Manual test: verify all settings restored including agents, commands, and UI preferences
...
- [x] Manual test: toggle setting on/off and verify prompt persistence behavior
...
- [x] Manual test: click each placeholder and verify correct value inserted at cursor
