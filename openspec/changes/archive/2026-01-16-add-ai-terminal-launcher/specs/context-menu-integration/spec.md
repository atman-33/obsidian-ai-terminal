# Specification: Context Menu Integration
...
**Depends on**:
- `command-templates`: Determines which commands to register
- `placeholder-system`: Provides context for placeholder resolution
- `terminal-launcher`: Executes the command when triggered

**Required by**: None (integration capability)
