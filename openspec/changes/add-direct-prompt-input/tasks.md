...
- [ ] **2.1 Create agent list editor component**
...
- [ ] **2.2 Integrate agent editor into settings tab**
...
- [ ] **2.3 Add agent deletion safeguards**
...
- [ ] **2.4 Implement enable/disable toggle**
...
- [ ] **3.1 Update command template editor**
...
- [ ] **3.2 Add agent reference validation**
...
- [ ] **3.3 Handle missing agent scenarios**
...
- [ ] **4.1 Create DirectPromptModal component**
...
- [ ] **4.2 Implement agent selection dropdown**
...
- [ ] **4.3 Implement context display area**
...
- [ ] **4.6 Add empty agent validation**
...
- [ ] **5.1 Add "Direct Prompt..." to file context menu**
...
- [ ] **5.2 Add "Direct Prompt..." to editor context menu**
...
- [ ] **5.3 Add "Direct Prompt" to command palette**
...
- [ ] **5.4 Position menu items correctly**
...
- [ ] **6.1 Unit tests for agent management**
...
- [ ] **6.2 Unit tests for DirectPromptModal**
